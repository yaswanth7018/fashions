              ...
              <div class="card rounded-3 text-black">
                <div class="row g-0">
                  <div class="col-lg-6">
                    ...
                    <center>
                        <p style="font-weight: 600; font-size: 20px;">Please login to your account</p>
                    </center>
...
<% } %>
      ...
      <p style="color:red">${faild}</p>
                        <div class="text-center pt-1 mb-5 pb-1">
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"  style="background: linear-gradient(to bottom, #ff5151 50%, #ff5e3a); border: none;width: 100%" type="submit">Log
                            in</button>
                        ...
                        <div class="d-flex align-items-center justify-content-center pb-4">
                          ...
                          <a type="button" class="btn btn-outline-danger" style="background: ;" href="/register">Create new</a>
                        </div>
