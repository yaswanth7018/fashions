...
<form method="post" action="/saveproduct" enctype="multipart/form-data" class="col-md-4" style="left: 50%;
  ...
  <select class="form-select" id="inputGroupSelect01" name="cat">
    ...
    <option value="tshirts">TShirst</option>
    <option value="casulashirts">Casula Shirts</option>
     <option value="formalshirts">Formal Shirts</option>
      <option value="sweatshirts">SweatShirts</option>
       <option value="jackets">Jackets</option>
        <option value="jeens">Jeens</option>
        <option value="casulatrousers">Casula Trousers</option>
          <option value="trackjoggers">Track Pants & Joggers</option>
           <option value="kurtas">kurtas & Suits</option>
            <option value="saree">Sarees</option>
             <option value="skirts">Skirts</option>
              <option value="sweatshirts">Women sweatshirts</option>
               <option value="jackets">Women Jackets</option>
                <option value="jeens">Woomen Jeens</option>
                 <option value="womendress">Dress</option> 
                 <option value="womenethicware">Women Ethnic Ware</option> 
  </select>
</div>
</div>
